...
public class CredencialController {
    ...
    public String login(
        ...
        if(credencialBD!=null){
            request.getSession().setAttribute("medicoLogueado", credencialBD); //si es que se encuentra el usuario volvera a index "logueado"
            return "index";
        }else{
            model.addAttribute("credencial", new Credencial()); //mandar credencial vacía para que lo intente denuevo
